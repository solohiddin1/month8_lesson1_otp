...
from app.views.homework import HomeworkDetailView, HomeworkPutMarkView, HomeworkUploadView, HomeworkView, LessonHomeworkView
...
urlpatterns = [
    ...
    path('api/lesson/<int:lesson_id>/homework/',LessonHomeworkView.as_view(), name='api_lesson_homework'),
